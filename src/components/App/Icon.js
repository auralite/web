...
export const ImageOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
		<path d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
	</Icon>
)

export const GlobeOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
		<path d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
	</Icon>
)

export const UserCircleOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
...
export const UploadSolid = ({ className }) => (
	<Icon className={className} isSolid={true}>
		<path d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM6.293 6.707a1 1 0 010-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L11 5.414V13a1 1 0 11-2 0V5.414L7.707 6.707a1 1 0 01-1.414 0z" />
	</Icon>
)

export const CheckCircleOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
		<path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
	</Icon>
)

export const CrossSolid = ({ className }) => (
	<Icon className={className} isSolid={true}>
		<path d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" />
	</Icon>
)

export const ReplySolid = ({ className }) => (
	<Icon className={className} isSolid={true}>
		<path fillRule="evenodd" d="M7.707 3.293a1 1 0 010 1.414L5.414 7H11a7 7 0 017 7v2a1 1 0 11-2 0v-2a5 5 0 00-5-5H5.414l2.293 2.293a1 1 0 11-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clipRule="evenodd" />
	</Icon>
)

export const AtSolid = ({ className }) => (
	<Icon className={className} isSolid={true}>
		<path fillRule="evenodd" d="M14.243 5.757a6 6 0 10-.986 9.284 1 1 0 111.087 1.678A8 8 0 1118 10a3 3 0 01-4.8 2.401A4 4 0 1114 10a1 1 0 102 0c0-1.537-.586-3.07-1.757-4.243zM12 10a2 2 0 10-4 0 2 2 0 004 0z" clipRule="evenodd" />
	</Icon>
)

export const ChevronDownOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
...
export const CogOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
...
export const CogSolid = ({ className }) => (
	<Icon className={className} isSolid={true}>
...
export const SparklesOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
		<path d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
	</Icon>
)

export const SparklesSolid = ({ className }) => (
	<Icon className={className} isSolid={true}>
		<path fillRule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm0 10a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0v-1H3a1 1 0 110-2h1v-1a1 1 0 011-1zM12 2a1 1 0 01.967.744L14.146 7.2 17.5 9.134a1 1 0 010 1.732l-3.354 1.935-1.18 4.455a1 1 0 01-1.933 0L9.854 12.8 6.5 10.866a1 1 0 010-1.732l3.354-1.935 1.18-4.455A1 1 0 0112 2z" clipRule="evenodd" />
	</Icon>
)
export const ArrowLeftOutline = ({ className }) => (
	<Icon className={className} isSolid={false}>
